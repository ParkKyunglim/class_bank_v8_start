...
<div class="col-sm-8">
	...
	<form action="/user/sign-up" method="post" enctype="multipart/form-data">
		...
		<div>
			<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=275f378d5dca47a1708b08de54796f36&redirect_uri=http://localhost:8080/user/kakao">
